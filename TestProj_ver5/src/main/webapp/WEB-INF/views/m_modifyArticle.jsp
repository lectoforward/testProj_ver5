				...
				<article id="post-298" class="post-298 page type-page status-publish hentry">
					...
					<div class="entry-content">
						...
						<div class="single_pgbx single_edit">
							<form id="formWrite" action="/m_modifyArticle" method="POST">
								<input type="hidden" name="job" value="articleAdd">
								<input type="hidden" name="userId" id="userId" value="${sessionScope.id}" />
								<input type="hidden" name="content" id="content" value="${ArticleVO.articleContent}"/>
								<input type="hidden" name="boardCode" id="boardCode" value="${boardCode}" />
								<input type="hidden" name="articleHits" id="articleHits" value="${ArticleVO.articleHits}">
								<input type="hidden" name="page" value="${page}">
								<input type="hidden" name="articleCode" id="articleCode" value="${articleCode}">
								<input type="hidden" name="notice" id="notice" value="${ArticleVO.notice}">
						...
						<!--  데이터  -->
								...
								<div class="single_headbx two" >
									<div class="single_tblbx">
										<div class="title_bx"><input type="text" name="articleTitle" id="articleTitle" class="single_edit_title" placeholder="제목을 입력해주세요." value="${ArticleVO.articleTitle}"></div>
									</div>
								</div>
								<!--  .싱글페이지 헤더-->
								<!-- 싱글컨텐츠 -->
								<div class="single_contbx">
									<div class="single_container">
										<div>
											<textarea name="articleContent" id="articleContent">${ArticleVO.articleContent}</textarea>
										</div>
								...
								<div class="basic_btnbx">
									<!-- <div class="basic_btn btn_save" id="btnSave" onClick="save();"><span class="text">수정</span></div> -->
									<input type="submit" name="updateArticle" id="updateArticle" class="basic_btn btn_save" value="수정">
								</div>
								<!-- .목록버튼 -->
							</form>
						</div>
						...
						<!--  데이터  -->
								...
								<div class="single_headbx two" >
									<div class="single_tblbx">
										<div class="title_bx"><input type="text" name="articleTitle" class="single_edit_title" placeholder="제목을 입력해주세요." value="${ArticleVO.articleTitle}"></div>
									</div>
								</div>
								<!--  .싱글페이지 헤더-->
								<!-- 싱글컨텐츠 -->
...
jQuery(document).ready(function($){
	 ...
	 /* $('#btnSave').bind('click', function(e){ */
		...
		var page=${page};
		$form.attr('method', 'POST');
		$form.attr('action','/m_modifyArticle');
		$form.submit();
